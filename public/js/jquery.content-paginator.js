	...
	$.fn.contentPaginator.paginator = {
		...
		_nav: function() {
			return $('<div class="content-paginator-nav">' + 
					...
					'<span class="content-paginator-button-prev border-0 btn-dark-gray rounded-circle font-weight-bold icon-back-01" href="">' + this.options.prevText + '</span>' +

					'<span class="content-paginator-numbers px-2 label-font-size MyriadProIt"></span>' +

					'<span class="content-paginator-button-next border-0 btn-dark-gray rounded-circle font-weight-bold icon-fwrd-01" href="">' + this.options.nextText + '</span>' +

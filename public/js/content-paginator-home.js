...
(function($) {
	...
	$.fn.contentPaginator.paginator = {
		create: function($element, options) {
			...
			$('<div class="content-paginator-page-mision-vision" />').appendTo(this.$container).css({
				width: $element.width(),
		...
		refresh: function() {
			var duration = this._initialized ? this.options.duration : 0,
				...
				$nav =  this.$pageNav.find('.content-paginator-numbers');
		...
		_init: function() {
			...
			this.$pages = this.$element.empty().append(this.$container.css('visibility', 'visible')).find('.content-paginator-page-mision-vision');
		...
		_nav: function() {
			return $('<div class="content-paginator-nav">' + 
					...
					'<span class="content-paginator-button-prev fp-controlArrow-lg fp-prev-lg border-0 btn-dark-gray rounded-circle font-weight-bold icon-back-01" href="">' + this.options.prevText + '</span>' +

					'<span class="content-paginator-numbers px-2 label-font-size MyriadProIt"></span>' +

					'<span class="content-paginator-button-next fp-controlArrow-lg fp-next-lg border-0 btn-dark-gray rounded-circle font-weight-bold icon-fwrd-01" href="">' + this.options.nextText + '</span>' +

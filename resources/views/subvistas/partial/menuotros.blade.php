<header class="header-others img-fluid hidden-sm-down" style=" background-image:url({{ URL::asset('uploads/menuotros.jpg') }}); background-size: cover;">
          <div class="container">
            ...
            <div class="d-flex justify-content-center pt-3 pt-md-0">
              <nav class="nav text-center flex-column flex-md-row nav-biocubafarma MyriadProBoldCond">
                ...
                <a class="nav-link nav-lik-biocubafarma mb-3 mb-md-0" href="{{url('/empresas')}}">empresas</a>
                ...
                <a class="active-white nav-link nav-lik-biocubafarma mb-3 mb-md-0" href="{{url('/otros')}}">otros</a>
              </nav>
            </div>
          </div>
        </header>

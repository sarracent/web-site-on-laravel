        ...
        <div class="container">
            ...
            <div class="d-flex flex-row padding-menu align-items-center justify-content-center justify-content-md-end">
                <div class="mr-brand-auto">   
                    <a class="navbar-brand py-0 impact color-dark-gray" href="#">BioCubaFarma</a>
                    <a href="menu.blade.php"></a>
                </div>
                <div class="hidden-sm-down pt-3">
                    <a href="#"><i class="border-0 rounded-circle btn-dark-gray icon-eng mr-2"></i></a>
                </div>
                <div class="hidden-sm-down pt-3">
                    <a href="feed" target="_blank"><i class="border-0 rounded-circle btn-dark-gray icon-sss-01 mr-2 rss"></i></a>
                </div>
                <div class="hidden-sm-down pt-3">
                    <a href="mailto:direccion@dominio.com"><i class="border-0 rounded-circle btn-dark-gray icon-mail mr-3"  ></i></a>
                </div>
                <div class="hidden-sm-down pt-3">
            ...
            <div class="d-flex justify-content-center pt-3 pt-md-0">
                <nav class="nav text-center flex-column flex-md-row nav-biocubafarma-dark-gray MyriadProBoldCond">
                    <a class="active-black nav-link nav-lik-biocubafarma-dark mb-3 mb-md-0 color-dark-gray" href="{{url('/inicio')}}">inicio</a>
                    <a class="nav-link nav-lik-biocubafarma-dark mb-3 mb-md-0 color-dark-gray" href="{{url('/noticias')}}">noticias</a>

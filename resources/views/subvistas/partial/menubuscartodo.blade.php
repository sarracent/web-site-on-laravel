        ...
        <header class="header-home home-menu-img img-fluid hidden-sm-down">
          <div class="container">
            ...
            <div class="d-flex justify-content-center pt-3 pt-md-0">
              <nav class="nav text-center flex-column flex-md-row nav-biocubafarma MyriadProBoldCond">
                <a class="active-white nav-link nav-lik-biocubafarma mb-3 mb-md-0" href="{{url('/inicio')}}">inicio</a>

...
</div><div class="form-group {{ $errors->has('subtitulo') ? 'has-error' : ''}}">
    {!! Form::label('subtitulo', 'Subtitulo', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
        {!! Form::text('subtitulo', null, ['class' => 'form-control']) !!}
        {!! $errors->first('subtitulo', '<p class="help-block">:message</p>') !!}
    </div>

<div class="form-group {{ $errors->has('titulo') ? 'has-error' : ''}}">
    {!! Form::label('titulo', 'Empresa', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
...
<div class="form-group {{ $errors->has('descripcion') ? 'has-error' : ''}}">
    {!! Form::label('descripcion', 'Nombre Completo', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
        {!! Form::text('descripcion', null, ['class' => 'form-control']) !!}
        {!! $errors->first('descripcion', '<p class="help-block">:message</p>') !!}
    </div>
</div><div class="form-group {{ $errors->has('clasificacion') ? 'has-error' : ''}}">
    {!! Form::label('clasificacion', 'Clasificacion', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
    ...
    {!! Form::label('cuerpo', 'Descripción', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">

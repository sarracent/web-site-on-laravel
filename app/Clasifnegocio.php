...
class Clasifnegocio extends Model {
     ...
     * @var string
     */
    protected $table = 'clasifnegocios';
     ...
     * @var array
     */
    protected $fillable = ['clasificacion', 'foto', 'foto', 'foto2', 'foto3', 'foto4', 'foto5'];
    ...
    public function setFotoAttribute($foto) {
        if ($foto == 'null') {
            ...
            if (!is_null(\DB::table('empresas')->find($this->id))) {
                \Storage::disk('local')->delete(\DB::table('noticias')->find($this->id)->foto);
    ...
    public function setFoto5Attribute($foto5) {
        if ($foto5 == 'null') {
            /* if(!is_null(\DB::table('empresas')->find($this->id))){
              \Storage::disk('local')->delete(\DB::table('clasifnegocios')->find($this->id)->foto5);
